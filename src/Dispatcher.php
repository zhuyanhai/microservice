...
use Zyh\MicroService\Exception\InternalHttpException;
...
class Dispatcher
{
     ...
     * @param array $files
     *
     * @return \Zyh\MicroService\Dispatcher
     */
    ...
    protected function queueRequest($verb, $uri, $parameters, $content = '')
    {
        ...
        // internally dispatching an microservice request. We need to capture this request as well
     ...
     * @param string|array $parameters
     *
     * @return \Zyh\MicroService\Http\InternalRequest
     */
     ...
     * 尝试调度一个内部请求
     *
     * @param \Zyh\MicroService\Http\InternalRequest $request
     *
