...
use Zyh\MicroService\Routing\Adapter\Lumen as LumenAdapter;
...
class LumenServiceProvider extends ZyhServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app->routeMiddleware([
            'microservice.auth' => Auth::class,
            'microservice.throttle' => RateLimit::class,
            'microservice.controllers' => PrepareController::class,
        ]);
    }
