...
class Docs extends Command
{
     ...
     * @var string
     */
    protected $signature = 'microservice:docs {--name= : Name of the generated documentation}
     ...
     * @var string
     */
    protected $description = 'Generate microservice documentation from annotated controllers';
