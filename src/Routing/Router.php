...
namespace Zyh\MicroService\Routing;
...
class Router
{
     ...
     *
     * @var \Zyh\MicroService\Contract\Routing\Adapter
     */
    protected $adapter;
     ...
     *
     * @var \Zyh\MicroService\Http\Parser\Accept
     */
    protected $accept;
     ...
     *
     * @var \Zyh\MicroService\Routing\Route
     */
     ...
     *
     * @param \Zyh\MicroService\Contract\Routing\Adapter        $adapter
     * @param \Zyh\MicroService\Http\Parser\Accept              $accept
    ...
    /**
     * An alias for calling the group method, allows a more fluent microservice
     * for registering a new microservice version group with optional
    ...
    public function group(array $attributes, $callback)
    {
        ...
        if (! isset($attributes['version'])) {
            throw new RuntimeException('A version is required for an microservice group definition.');
        } else {
    ...
    {
        array_unshift($action['middleware'], 'microservice.controllers');
     ...
     *
     * @return \Zyh\MicroService\Routing\Route
     */
    ...
    public function setAdapterRoutes(array $routes)
    {
        ...
        $this->container->instance('microservice.routes', $this->getRoutes());
    }
