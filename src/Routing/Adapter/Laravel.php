...
namespace Zyh\MicroService\Routing\Adapter;
...
use Zyh\MicroService\Exception\UnknownVersionException;
...
class Laravel implements Adapter
{
    ...
    /**
     * Array of merged old routes and microservice routes.
     *
     * @var array
     */
    ...
    /**
     * Merge the old application routes with the microservice routes.
     *
     * @param string $version
     *
     * @return array
