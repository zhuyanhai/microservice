...
class Route
{
     ...
     *
     * @return string|\Zyh\MicroService\Contract\Http\RateLimit\Throttle
     */
    protected $throttle;
    ...
    {
        if (isset($this->middleware['microservice.auth']) || in_array('microservice.auth', $this->middleware)) {
            if ($this->controller && isset($this->middleware['microservice.auth'])) {
                return $this->optionsApplyToControllerMethod($this->middleware['microservice.auth']);
            }
     ...
     *
     * @return string|\Zyh\MicroService\Http\RateLimit\Throttle\Throttle
     */
