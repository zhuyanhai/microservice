...
/**
 * @property \Zyh\MicroService\Dispatcher $microservice
 * @property \Illuminate\Auth\GenericUser|\Illuminate\Database\Eloquent\Model $user
 * @property \Zyh\MicroService\Auth\Auth $auth
 */
trait Helpers
{
    /**
     ...
     *
     * @param string|\Zyh\MicroService\Contract\Http\RateLimit\Throttle $class
     * @param array                                              $options
     *
     * @return void
     */
