...
namespace Zyh\MicroService\Http\RateLimit;

use Zyh\MicroService\Http\Request;
use Illuminate\Cache\CacheManager;
use Illuminate\Support\Collection;
use Illuminate\Container\Container;
use Zyh\MicroService\Http\RateLimit\Throttle\Route;
use Zyh\MicroService\Contract\Http\RateLimit\Throttle;
use Zyh\MicroService\Contract\Http\RateLimit\HasRateLimiter;
...
class Handler
{
     ...
     *
     * @var \Zyh\MicroService\Contract\Http\RateLimit\Throttle
     */
    protected $throttle;
    ...
    {
        return sprintf('zhuyanhai.microservice.%s.%s.%s', $this->keyPrefix, $key, $this->getRateLimiter());
    }
     ...
     *
     * @param string|\Zyh\MicroService\Contract\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
     ...
     *
     * @return \Zyh\MicroService\Contract\Http\RateLimit\Throttle
     */
     ...
     *
     * @param callable|\Zyh\MicroService\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
