...
use Zyh\MicroService\Http\Parser\Accept;
use Illuminate\Http\Request as IlluminateRequest;
use Zyh\MicroService\Contract\Http\Request as RequestInterface;
...
class Request extends IlluminateRequest implements RequestInterface
{
     ...
     *
     * @param \Zyh\MicroService\Http\Parser\Accept $acceptParser
     *
     * @return void
     */
     ...
     * 获取请求报头解析实例
     *
     * @return \Zyh\MicroService\Http\Parser\Accept
     */
