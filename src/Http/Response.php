...
use Zyh\MicroService\Event\ResponseIsMorphing;
use Zyh\MicroService\Event\ResponseWasMorphed;
...
class Response extends IlluminateResponse
{
    ...
    /**
     * Make an microservice response from an existing Illuminate response.
     *
    ...
    /**
     * Make an microservice response from an existing JSON response.
     *
    ...
    /**
     * Morph the microservice response to the appropriate format.
     *
     * @param string $format
     *
     * @return \Zyh\MicroService\Http\Response
     ...
     *
     * @return \Zyh\MicroService\Http\Response\Format\Format
     */
     ...
     *
     * @param string                                 $key
     * @param \Zyh\MicroService\Http\Response\Format\Format $formatter
     *
     * @return void
     */
